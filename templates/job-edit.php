<?php include 'inc/header1.php'; 
	...
	<form method="post" action="edit.php?id=<?php echo $job->id;  ?>">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="contactu" value="<?php echo $job->contactu; ?>">
		</div>
		<div class="form-group">
			<label>Contact Email</label>
			<input type="text" class="form-control" name="contacte" value="<?php echo $job->contacte; ?>">
		</div>
